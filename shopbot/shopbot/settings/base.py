"""Базовые настройки проекта shopbot (общие для всех окружений)."""
import os
from pathlib import Path

from decouple import Csv, config

# BASE_DIR — каталог с manage.py (на уровень выше пакета shopbot/)
BASE_DIR = Path(__file__).resolve().parent.parent.parent

SECRET_KEY = config('DJANGO_SECRET_KEY', default='mega_secret_key')
